...
`indicate_mouse_touch` is a function that can be used to flag mouse and touch screens/devices based on the number of recorded movements. There is a numeric cutoff used to distinguish touch from mouse input. Screens with at most this number of events are classified as touch. Currently the cutoff defaults to 50. 
...
mousemove_remove <- indicate_mouse_touch(mouse_clean, max_cutoff = 50, traj_id = "mt_id",max_cutoff = 50,level = "screen")
```
